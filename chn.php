	...
	<body>
		...
		function sendEmail($to, $subject, $message) {
			...
			if (mail($to, $subject, $message, $headers)) {
				...
				echo("<h4>To: $to <br>Subject: $subject <br>Body: $message</h4>");
				echo("<br>Again? <a href=\"http://www.samgarst.com/CHN\">samgarst.com/CHN</a></article>");
